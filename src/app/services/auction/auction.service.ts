...
export class AuctionService {
 ...
 auctionPrice(user_id:any,room_id : any, ammount:any){
   return this.httpclient.put(this.back_URL +`/usern/Auctionromm/${user_id}/${room_id}/${ammount}`,null)
 }
 leaveRoom(user_id:any,room_id : any){
   return this.httpclient.put(this.back_URL +`/usern/leaveAuctionromm/${user_id}/${room_id}`,null)
 }
